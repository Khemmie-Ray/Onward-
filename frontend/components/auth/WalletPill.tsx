        ...
        createPortal(
          <>
            ...
            <aside
              ...
              className={`fixed right-0 top-0 z-50 flex h-dvh w-full max-w-full flex-col bg-canvas transition-transform duration-300 ease-out sm:max-w-95 md:max-w-100 ${
                open
            ...
            >
              {view === "keys" ? (
                <WalletDetails onBack={() => setView("main")} />
              ) : (
                <>
                  ...
                  <div className="flex-1 overflow-y-auto px-4 py-3 sm:px-5">
                    ...
                    <p className="mt-4 text-[11.5px] leading-relaxed text-fg-soft/80">
                      These balances live on the Celo network at your address
                      above. Anything you earn on Onward arrives here.
                    </p>
                  </div>
